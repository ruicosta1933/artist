    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.division}>
                ...
                <iframe width="100%" height="450" scrolling="no" frameBorder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1355541847&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div className={styles.soundCloud}><a href="https://soundcloud.com/iamdacosta" title="dacosta" target="_blank" className={styles.soundCloud2}>dacosta</a> · <a href="https://soundcloud.com/iamdacosta/sets/intelligence-with-wings-trailer" title="Intelligence with Wings (Trailer)" target="_blank" className={styles.soundCloud2}>Intelligence with Wings (Trailer)</a></div>
                </div>
            </div>
        </div>
    )
